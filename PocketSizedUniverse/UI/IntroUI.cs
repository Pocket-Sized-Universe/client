...
public partial class IntroUi : WindowMediatorSubscriberBase
{
    ...
    protected override void DrawInternal()
    {
        ...
        {
            _uiShared.BigText("Welcome to Pocket Sized Universe");
            ImGui.Separator();
            UiSharedService.TextWrapped("Pocket Sized Universe is a plugin that will replicate your full current character state including all Penumbra mods to other paired Pocket Sized Universe users. " +
                     ...
                     || !Directory.Exists(_configService.Current.CacheFolder)))
        {
            ...
            {
                UiSharedService.TextWrapped("To not unnecessary download files already present on your computer, Pocket Sized Universe will have to scan your Penumbra mod directory. " +
                                     "Additionally, a local storage folder must be set where Pocket Sized Universe will download other character files to. " +
                                     "Once the storage folder is set and the scan complete, this page will automatically forward to registration at a service.");
                UiSharedService.TextWrapped("Note: The initial scan, depending on the amount of mods you have, might take a while. Please wait until it is completed.");
                UiSharedService.ColorTextWrapped("Warning: once past this step you should not delete the FileCache.csv of Pocket Sized Universe in the Plugin Configurations folder of Dalamud. " +
        ...
        else if (!_uiShared.ApiController.ServerAlive)
        {
            ...
            ImGui.Separator();
            UiSharedService.TextWrapped("To be able to use Pocket Sized Universe you will have to register an account.");
            UiSharedService.TextWrapped("For the official Pocket Sized Universe Servers the account creation will be handled on the official Pocket Sized Universe Discord. Due to security risks for the server, there is no way to handle this sensibly otherwise.");
